...
public class FlightInformationTest4 {

  @Test
  void constructor_sets_all_fields_correctly() {
    
      FlightInformation startFlights = new FlightInformation("", "" ,70, "Male" ,"BobMitchell@gmail.com", "01234567893", "Seoul", "01/07/2025", "04:00", "402"); //For reference, this is made up data.

      assertEquals("", startFlights.getFirstName());
      assertEquals("", startFlights.getLastName());
