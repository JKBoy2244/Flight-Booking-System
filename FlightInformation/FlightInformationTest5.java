...
public class FlightInformationTest5 {

   @Test
   void constructor_sets_all_fields_correctly() {
    
      FlightInformation startFlights = new FlightInformation("Bob", "Mitchell" ,115, "Male" ,"BobMitchell@gmail.com", "01234567893", "Seoul", "01/07/2025", "04:00", "402"); //For reference, this is made up data.
    
      assertEquals("Bob", startFlights.getFirstName());
      assertEquals("Mitchell", startFlights.getLastName());
      assertEquals(115, startFlights.getAge());
